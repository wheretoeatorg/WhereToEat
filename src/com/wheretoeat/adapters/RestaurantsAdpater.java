...
public class RestaurantsAdpater extends ArrayAdapter<Restaurant> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (location2 != null && currentLocation != null && currentLocation.length > 0 && location2.length > 0) {
			double distance = Utility.distance(currentLocation[0], currentLocation[1], location2[0], location2[1]);
